...
const salaryDayInput = document.querySelector("#salary-day");
...
const persistState = () => {
  const payload = {
    ...
    monthlySavings: monthlySavingsInput.value,
...
const restoreState = () => {
  ...
  try {
    ...
    monthlyIncomeInput.value = data.monthlyIncome ?? "";
    monthlySavingsInput.value = data.monthlySavings ?? "";
    salaryDayInput.value = data.salaryDay ?? "";
